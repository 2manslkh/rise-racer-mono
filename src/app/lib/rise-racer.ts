...
const riseRacerAbi = [
  ...
  },
  {
    ...
    name: "bindAddress",
    inputs: [
      { name: "_boundAddress", type: "address", internalType: "address" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  ...
  },
  {
    ...
    inputs: [{ name: "_binder", type: "address", internalType: "address" }],
    outputs: [{ name: "", type: "address", internalType: "address" }],
    stateMutability: "view",
  },
  {
    ...
    outputs: [
      {
        ...
        components: [
          { name: "velocity", type: "uint256", internalType: "uint256" },
          { name: "currentStage", type: "uint8", internalType: "uint8" },
          { name: "currentUniverse", type: "uint256", internalType: "uint256" },
          { name: "totalClicks", type: "uint256", internalType: "uint256" },
          { name: "isStaking", type: "bool", internalType: "bool" },
        ],
      },
    ],
    stateMutability: "view",
